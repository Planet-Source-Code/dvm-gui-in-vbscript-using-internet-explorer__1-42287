...
dim oIE
set oIE = createIEWindow("", "", 250, 100, "createDiv by vOOs.........", "oIE_")

set oDiv = createDiv(oIE, "Hello world!", 10, 10, 220, 50)
dim oDiv

oDiv.style.textAlign = "center"
oDiv.style.font = "24Pt Comic Sans MS"

function createDiv(byVal Window, byVal sValue, byVal pxLeft, byVal pxTop, byVal pxWidth, byVal pxHeight)  
  dim localObject: set localObject = Window.document.createElement("<DIV>")
