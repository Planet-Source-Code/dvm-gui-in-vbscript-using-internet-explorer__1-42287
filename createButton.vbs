...
dim oIE
set oIE = createIEWindow("", "", 270, 80, "createButton by vOOs..........", "oIE_")

dim iptButton
set iptButton = createButton(oIE, "Click Me", 50, 10, 160, 25, "iptButton_onClick")
...
function createButton(byVal Window, byVal sValue, byVal pxLeft, byVal pxTop, byVal pxWidth, byVal pxHeight, byVal sCallBack)
  dim localObject: set localObject = Window.document.createElement("<BUTTON>")
